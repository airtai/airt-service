...
# %% auto 0
__all__ = ['description', 'json_datetime_sec_encoder', 'ModelType', 'ModelTrainingRequest', 'EventData', 'RealtimeData',
           'TrainingDataStatus', 'TrainingModelStart', 'TrainingModelStatus', 'ModelMetrics', 'Prediction',
           'create_fastkafka_application', 'create_ws_server']
...
# %% ../notebooks/API_Web_Service.ipynb 21
