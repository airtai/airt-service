...
def create_ws_server(
    ...
    async def on_infobip_start_training_data(msg: ModelTrainingRequest):  # type: ignore
    ...
    async def on_infobip_training_data(msg: EventData):  # type: ignore
    ...
    async def on_infobip_realtime_data(msg: RealtimeData):  # type: ignore
        pass
