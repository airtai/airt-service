...
# %% auto 0
__all__ = ['heading', 'json_datetime_sec_encoder', 'LogMessage', 'add_logging', 'TaskType', 'ModelTrainingRequest', 'EventData',
...
def _construct_kafka_brokers() -> Dict[str, Dict[str, Any]]:
    ...
    kafka_brokers = {
        "staging": {
            "url": "kafka-cluster-1.staging.airt.ai",
