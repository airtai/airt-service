...
# %% auto 0
__all__ = ['get_valid_sso_providers', 'SSOAuthURL', 'initiate_sso_flow', 'get_sso_protocol_and_email', 'update_user_info_in_db',
...
def update_user_info_in_db(
    ...
    with get_session_with_context() as session:
        try:
            ...
            user.username = (
                f'{user_info_from_provider["name"].replace(" ", "_")}_{random_number}'
            )
